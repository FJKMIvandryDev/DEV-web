		...
		<form action="#" method="POST">
			...
			<table>
				<tr>
					...
					<td><input type="text" id="anarana"></input></td>
				</tr>

				<tr>
					<td><label for="sary">Sary : </label></td>
					<div id="image" onclick="openKCFinder(this)">
						<div style="margin:5px">Click here to choose an image</div>
					</div>
					<td><input type="text" id="sary" value=""></input></td>
					<td><button id="findButton">find</button></td>
				</tr>
				...
				<tr>
					...
					<td><input type="number" id="isa"></input></td>
				</tr>
			</table>
